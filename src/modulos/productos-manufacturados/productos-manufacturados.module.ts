...
import {
  ...
  RubroProductoManufacturadoSchema,
} from './rubro-producto-manuacturado/schemas/rubro-producto-manufacturado.schema';
import {
  ProductoManufacturado,
  ProductoManufacturadoSchema,
} from './producto-manufacturado/schemas/producto-manufacturado.schema';
import { AuthModule } from '../auth/auth.module';

@Module({
  controllers: [
    RubroProductoManufacturadoController,
    ProductoManufacturadoController,
  ],
  providers: [ProductoManufacturadoService, RubroProductoManufacturadoService],
  imports: [
    MongooseModule.forFeature([
      {
        name: RubroProductoManufacturado.name,
        schema: RubroProductoManufacturadoSchema,
      },
      { name: ProductoManufacturado.name, schema: ProductoManufacturadoSchema },
    ]),
    AuthModule,
  ],
  exports: [ProductoManufacturadoService],
})
